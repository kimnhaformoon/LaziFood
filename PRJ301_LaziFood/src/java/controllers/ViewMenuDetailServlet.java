 ...
 * @author long
 */
public class ViewMenuDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String txtId = request.getParameter("txtMenuId");
            if (txtId == null) {
                txtId = "1";
            }
            ...
            menuDao.getDayMenu(day, menuDto);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ViewMenuDetailServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
