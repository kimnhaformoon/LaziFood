 ...
 * @author long
 */
public class DeleteDishFromPlanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (txtPlanId == null || txtDay == null || txtDishId == null
                    || txtPeriod == null || txtPlanId.isEmpty() || txtDay.isEmpty()
            ...
            planDao.deleteDishFromPlan(dishId, planId, period, day);
            request.getRequestDispatcher("ViewPersonalPlanServlet").forward(request, response);
        } catch (SQLException ex) {
            Logger.getLogger(DeleteDishFromPlanServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
