 ...
 * @author long
 */
public class GetMenuByCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int count = menudao.getTotalMenu(categoryId);
            ...
            menudao.getMenuByCategoryId(categoryId,index);
            request.setAttribute("LIST_MENU", menudao.getList());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetMenuByCategoryServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
