<%-- 
    Document   : editplanview
    Created on : Jul 12, 2024, 9:59:00 PM
    Author     : long
--%>
...
<head>
    ...
    <title>Thêm món ăn vào thực đơn cá nhân</title>
    ...
    <div style="margin-top:130px; margin-bottom:100px;">
        <div class="container mt-5">
            ...
            <div class="text-center mb-3">
                <h3>Mã thực đơn cá nhân: ${param.txtPlanId}</h3>
                <h3>
                    Thứ ${param.txtDay}
            ...
            <c:if test="${not empty requestScope.LIST_PRODUCT}">
                            ...
                            <div class="card card-product">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <form action="addDishToPlanAction" method="POST" class="ml-2">
                                            <input type="hidden" name="txtPlanId" value="${param.txtPlanId}">
                ...
                <div class="button-container">
                    <c:forEach var="page" begin="1" end="${requestScope.pageNum}">
                        <c:url var="url" value="addDishToPlanAction">
                            <c:param name="txtPlanId" value="${param.txtPlanId}"/>
