<%-- 
    Document   : manageDish
    Created on : Jul 12, 2024, 8:24:56 AM
    Author     : Kim Nha
--%>
    ...
    <body>
        ...
        <div class="main-body" id="main-body">
            <div id="sidebar">
                ...
                <a href="manageDishPage" class="active"><i class="bi bi-tags-fill"></i><h4><b>Quản lý món ăn</b></h4></a>
            ...
            <div id="main-content">
                <h3><b>Quản lý món ăn</b></h3>
                <a href="addNewDish" class="btn btn-default">
                    <i class="bi bi-plus-lg"></i> Thêm món ăn
                </a>
                <div class="search-container" >
                    <label>Phân loại</label>
                    <form action="manageDishPage" id="form-search-type">
                        ...
                        <select class="form-control" name="categoryId" id="select" onchange="document.getElementById('form-search-type').submit()" style="width: 16vw" >
                            ...
                            <c:forEach var="category" items="${requestScope.LIST_DISH_CATEGORIES}">
                                <option value="${category.id}">${category.name}</option>
                            </c:forEach>
                        </select>
                    </form>
                    <label>Tên món ăn</label>
                    <form action="manageDishPage">
                ...
                <c:if test="${empty requestScope.LIST_DISH}">
                    <label>Không có món ăn nào</label>
                </c:if>
                <c:if test="${not empty requestScope.LIST_DISH}">
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="main-box-body clearfix">
                                    <div class="table-responsive">
                                        <table class="table user-list">
                                            <thead>
                                                <tr>
                                                    <th class="text-center"><span>Món ăn</span></th>
                                            ...
                                            <tbody>
                                                <c:forEach var="dish" items="${requestScope.LIST_DISH}">
                                                    <tr>
                                                        <td>
                                                            <div class="user-container">
                                                                <img src="${dish.image}" alt/>
                                                                <a href="#" class="user-link">${dish.name}</a>
                                                            </div>
                                                        </td>
                                                        <td><fmt:formatNumber value="${dish.price}" type="currency" /></td>
                                                        <td>
                ...
                <div class ="button-container">
                    <c:forEach var = "page" begin= "1" end ="${requestScope.pageNum}">
                        <c:url var = "url" value="manageDishPage">
        ...
        <script>
            function showConfirmLock() {
                return confirm("Bạn có chắc chắn muốn xóa món ăn không?");
            }
