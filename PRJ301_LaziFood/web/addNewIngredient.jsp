        ...
        <div class="main-body" id="main-body">
            ...
            <div id="main-content">
                ...
                <div class="form-container">
                    <form action="addNewIngreAction" method="POST" id="form-info">
                        <div class="form-group">
                            <label class="mt-3">Tên nguyên liệu</label>
                            <input type="text" class="form-control" name="txtName" placeholder="Nhập tên nguyên liệu" required="">
                        </div>
                        <div class="form-group">
                            <label>Đơn giá</label>
                            <input type="text" class="form-control" name="txtPrice" id="price-input" placeholder="Nhập đơn giá" required="">
                            <p id="error-msg" style="color: red; display: none">Giá tiền không hợp lệ</p>
                        </div>
                        <div class="form-group">
                            <label>Đơn vị</label>
                            <input type="text" class="form-control" name="txtUnit" placeholder="Nhập đơn vị" required="">
                        </div>
                        <div class="form-group">
                            <label>Hình ảnh</label>
                            <input type="text" class="form-control" name="txtImage" placeholder="Nhập link ảnh" required="">
                        </div>
                        <div class="form-group">
