...
<html>
    ...
    <div class="main-body" id="main-body">
        ...
        <div id="main-content">
            <h3><b>Tạo mới món ăn</b></h3>
            <div class="form-container" style="width: 100%; display: flex; justify-content: space-around">
                <form class="form-info">
                    <h4><b>Món ăn</b></h4>
                    <div class="form-group">
                        <label for="name" class="mt-3">Tên món ăn</label>
                        <input type="text" class="form-control" id="name" placeholder="Nhập tên món ăn">
                    </div>
                    <div class="form-group">
                        <label for="price">Đơn giá</label>
                        <input type="number" class="form-control" id="price" placeholder="Nhập đơn giá">
                    </div>
                    <div class="form-group">
                        <label for="image">Hình ảnh</label>
                        <input type="text" class="form-control" id="image" placeholder="Nhập link ảnh">
                    </div>
                    <div class="form-group">
                        <label for="category">Phân loại</label>
                        <select class="form-control" id="category">
                            <option value="-1" disabled selected>Chọn phân loại</option>
