...
<html>
    ...
    <body>
        ...
        <div class="main-body" id="main-body">
            <div id="sidebar">
                <a href="adminDashBoard" class="active"><i class="bi bi-house-door-fill"></i><h4><b>Trang chủ</b></h4></a>
            ...
            <div id="main-content">
                <div class="welcome text-center">
                    <h3>Xin chào, <b>${sessionScope.LoginedAccount.fullname}</b></h3>
                    <h4>Hãy làm việc với Trang quản lý</h4>
                </div>
            </div>
        </div>
        <script>
