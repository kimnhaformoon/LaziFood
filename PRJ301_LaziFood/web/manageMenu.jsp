    ...
    <body>
        ...
        <div class="main-body" id="main-body">
            <div id="sidebar">
                ...
                <a href="manageMenuPage" class="active"><i class="bi bi-pencil-square"></i><h4><b>Quản lý thực đơn</b></h4></a>
            </div>
            <div id="main-content">
                <h3><b>Quản lý thực đơn</b></h3>
                <a href="addNewMenu" class="btn btn-default">
                    <i class="bi bi-plus-lg"></i> Thêm thực đơn
                </a>
                <div class="search-container" >
                    <label>Phân loại</label>
                    <form action="manageMenuPage" id="form-search-type">
                ...
                <c:if test="${empty requestScope.LIST_MENU}">
                    <label>Không có thực đơn nào</label>
                </c:if>
                                ...
                                <div class="main-box-body clearfix">
                                    <div class="table-responsive">
                                        <table class="table user-list">
                                            <thead>
                                                <tr>
                                                    <th class="text-center"><span>Thực đơn</span></th>
                                                    <th class="text-center"><span>Mô tả</span></th>
                                                    <th style="width: 100px"><span>Trạng thái</span></th>
                                                    <th></th>
                                                    <th></th>
                                                    <th></th>
                                                </tr>
                                            ...
                                            <tbody>
                                                <c:forEach var="menu" items="${requestScope.LIST_MENU}">
                                                    <tr>
                                                        <td>
                                                            <div class="user-container">
                                                                <img src="${menu.image}" alt/>
                                                                <a href="#" class="user-link">${menu.name}</a>
                                                            </div>
                                                        </td>
                                                        <td>${menu.description}</td>
                                                        <td>
                                                            <c:if test="${menu.status}">
                ...
                <div class ="button-container">
                    <c:forEach var = "page" begin= "1" end ="${requestScope.pageNum}">
                        <c:url var = "url" value="manageMenuPage">
        ...
        <script>
            ...
            function showConfirmLock() {
                return confirm("Bạn có chắc chắn muốn xóa thực đơn này không?");
            }
